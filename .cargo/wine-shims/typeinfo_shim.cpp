// MSVC's `type_info` and the sized `operator delete` live in the C++ runtime, which
// Wine does not ship. Nothing in this crate uses RTTI, but the linker still needs the
// vtable and the delete symbol to resolve.
